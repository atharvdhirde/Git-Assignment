...
var CurrentAccount = /** @class */ (function (_super) {
    ...
    function CurrentAccount(id, name, balance, credit) {
        return _super.call(this, id, name, balance = balance + credit) || this;
    }
    return CurrentAccount;
}(Account));
var savingAccount = new SavingAccount(001, "Atharv", 90000, 7);
var currentAccount = new CurrentAccount(002, "Dhirde", 80000, 12);
